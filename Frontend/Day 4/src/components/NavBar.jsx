    ...
    return(
        <div className="navbar-outer">
            ...
            <Link to="/contact-us" className="link-tag"><div className="navbar-field">CONTACT US</div></Link>
            {
                login ?
                <>
                    <Link to={(userOrAdmin=="user")?"/dashboard/your-profile":"/admin-dashboard/statistics"} className="link-tag" ><div className="navbar-field"><CgProfile size={35} className="navbar-profile-icon"/></div></Link>
                </>
                :
